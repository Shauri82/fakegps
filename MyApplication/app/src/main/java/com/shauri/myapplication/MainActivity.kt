package com.shauri.myapplication
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        floatingActionButton.setOnClickListener { addObject(Uri.parse("cupic_stopsign.sfb")) }
        showFab(false)
    ...
    private fun addNodeToScene(fragment: ArFragment, anchor: Anchor, renderable: ModelRenderable) {
        ...
        val spotLightYellow = Light.builder( Light.Type.FOCUSED_SPOTLIGHT)
            .setColor(com.google.ar.sceneform.rendering.Color(51f, 102f, 255f))
            .setShadowCastingEnabled(true)
            .build()
        anchorNode.light=spotLightYellow
        // TransformableNode means the user to move, scale and rotate the model
        val transformableNode = TransformableNode(fragment.transformationSystem)
        transformableNode.renderable = renderable
        transformableNode.scaleController.setMaxScale(0.02f);
        transformableNode.scaleController.setMinScale(0.01f);
        transformableNode.setParent(anchorNode)
        transformableNode.light=spotLightYellow
